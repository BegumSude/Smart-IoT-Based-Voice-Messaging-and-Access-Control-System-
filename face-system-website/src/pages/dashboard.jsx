            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg min-h-[500px]">
              ...
              {activeView === "stream" && (
                <div className="animate-fade-in flex flex-col items-center">
                  <h1 className="text-3xl font-bold mb-6 text-gray-800">ESP32 Canlı Yayın & Yüz Tanıma</h1>
                  ...
                  <div className="relative w-full max-w-2xl aspect-video bg-black rounded-xl overflow-hidden shadow-2xl border-4 border-gray-900">
                    ...
                    {/* MJPEG Yayını - crossOrigin eklenmiştir */}
                    <img
                      id="esp32-stream"
                      src={streamUrl}
                      alt="Canlı Yayın"
                    ...
                    {/* Face Recognition Overlay - streamElementId prop olarak gönderilir */}
                    <div className="absolute inset-0 pointer-events-none">
                      <FaceRecognition streamElementId="esp32-stream" />
                    </div>
                    ...
                    >
                      ...
                      <p className="text-sm text-gray-400 mt-2">ESP32 IP: {esp32cam_ip}</p>
                    </div>
                  </div>

                  {/* Alt Bilgi / İpucu Kutusu */}
